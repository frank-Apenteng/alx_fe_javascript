...
//     populateCategories();
//     showRandomQuote();
//     await syncQuotes(); // Sync with server after adding a new quote
...
//   populateCategories();
//   showRandomQuote();
//   await syncQuotes(); // Sync with server after deleting a quote
// }
...
//   await syncQuotes(); // Initial sync with server

//   // Periodically sync with server
//   setInterval(syncQuotes, 10000); // Every 10 seconds for demonstration purposes
// };
...
async function syncQuotes() {
  ...
  notifyUser('Quotes synced with server successfully.');
  console.log('Quotes synced with server!'); // Add log for debugging
}
